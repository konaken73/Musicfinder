...
class Musicfinder {
  static const MethodChannel _channel = const MethodChannel('musicfinder');
  ...
  Future<dynamic> prev(int url) =>
      _channel.invokeMethod('previous', {"url": url});
  ...
  Future<dynamic> seek(int seconds) => _channel.invokeMethod('seek', seconds);

  Future<dynamic> createPlaylist(String url) =>
      _channel.invokeMethod('createplaylist', {"playlist_name": url});

  Future<dynamic> Playlist() => _channel.invokeMethod('playlist');

  Future<dynamic> addMembers(List<String> members) =>
      _channel.invokeMethod('addTrackToplaylist', {"members": members});

  Future<dynamic> getTrackPlaylist(int playlist_id) =>
      _channel.invokeMethod('getTrackPlaylist', {"playlist_id": playlist_id});
  ...
  static Future<dynamic> AlbumSongs(int albumid) async {
    ...
    List<dynamic> Albumsongs =
        await _channel.invokeMethod('getAlbumSong', {"albumid": albumid});
  ...
  static Future<dynamic> ArtistSongs(String artist) async {
    ...
    List<dynamic> Artistsongs =
        await _channel.invokeMethod('getArtistSong', {"artist": artist});
